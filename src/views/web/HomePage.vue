...
<div class="relative flex min-h-screen flex-col justify-start overflow-hidden bg-gray-50">
 ...
 <div class="relative mx-auto w-full flex items-center justify-between p-6 text-sm font-semibold leading-6 text-slate-700 dark:text-slate-200 bg-[#0B1120]">
  <h1 class="text-lg text-sky-400">Al-Quran Digital</h1>
    ...
    <div class="hidden items-center md:flex">
      <nav>
        <ul class="flex items-center space-x-8">
          <li><a class="hover:text-sky-500 dark:hover:text-sky-400 text-gray-50 text-base" href="/docs/installation">Docs</a></li>
          <li><a href="https://tailwindui.com" class="hover:text-sky-500 dark:hover:text-sky-400 text-gray-50 text-base">Features</a></li>
          <li><a class="hover:text-sky-500 dark:hover:text-sky-400 text-gray-50 text-base" href="/blog">Blog</a></li>
        </ul>
      </nav>
      <div class="ml-6 flex items-center border-l border-slate-200 pl-6 dark:border-slate-800">
        ...
        ><button type="button" id="headlessui-listbox-button-3" aria-haspopup="true" aria-expanded="false" aria-labelledby="headlessui-listbox-label-2 headlessui-listbox-button-undefined">
          ...
          ></span></button
        ><a href="https://github.com/ekosutrisno/alquran-digital" class="ml-6 block text-slate-400 hover:text-slate-500 dark:hover:text-slate-300"
