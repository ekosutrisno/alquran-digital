    ...
    <div class="wrapper md:p-4 space-y-6">
        ...
        <section class="grid lg:grid-cols-2">
            <div
                ...
                <div class="pt-4">
                    <div v-if="ayah">
                        <p class="text-white rounded-sm bg-sky-500 w-max py-1 px-2 mb-2 text-sm"> {{
        ...
        <section>
            <div
                ...
                <div class="md:inline-flex hidden items-center space-x-2">
                    <button @click="hideMenuOption" type="button"
                        class="text-slate-700 relative group hover:bg-sky-500 rounded-sm p-0.5 transition">
                        ...
                        <div v-if="option" ref="target"
                            class="absolute overflow-hidden -bottom-20 w-36 card-shadow-md rounded-sm right-8 bg-white dark:bg-dark-blue ring-1 ring-slate-700/10 dark:ring-slate-700">
            ...
            <div v-if="$route.query.sajda != 'true' && !isLoading && isLogin && ayah"
                ...
                <button @click="onLanjutBacaan"
                    class="py-2 px-3 inline-flex items-center space-x-2 transition rounded-lg bg-sky-500 hover:bg-sky-600 text-white focus:outline-hidden"><span>Selanjutnya</span>
