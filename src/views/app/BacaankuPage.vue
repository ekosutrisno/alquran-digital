<template>
    ...
    <div class="wrapper md:p-4 space-y-6">
            ...
            <div class="bg-white card-shadow-md dark:bg-dark-blue ring-1 dark:ring-slate-700/50 ring-slate-700/10 rounded p-4 flex flex-col">
                <div class="w-full flex items-center justify-between border-b dark:border-slate-700/75 pb-2 px-1">
                    <p class="font-semibold text-slate-800 dark:text-white inline-flex items-center space-x-2 text-xl">
                        ...
                        <span v-else>Bacaanku (Not Found)</span> 
                    </p>
        ...
        <section>
            ...
            <div v-if="$route.query.sajda != 'true' && !state.isLoading" class="flex items-center my-4 justify-center">
             ...
             <div class="w-full rounded-md border-r-4 border-sky-400 mx-auto max-w-xl text-xs sm:text-sm text-center bg-white dark:bg-dark-blue dark:text-slate-100 mt-10 card-shadow-md ring-1 ring-slate-700/10 dark:ring-slate-700/50 max-h-16 h-full p-2">
