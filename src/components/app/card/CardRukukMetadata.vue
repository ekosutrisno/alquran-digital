<template>
<router-link v-motion-slide-bottom v-motion-slide-visible-once-bottom class="cursor-default sm:cursor-pointer" :to="{path: '/app/dashboard/alquran', query:{ sn: rukuk.surah, an: rukuk.ayah}}">
