<template>
    <div class="w-full h-full flex flex-col group items-start justify-start p-4 space-y-4 hover:border-sky-500 dark:hover:border-sky-500 transition bg-white dark:bg-dark-blue border-2 border-slate-700/10 card-shadow-sm rounded dark:border-slate-700/50">
      <!-- Header -->
