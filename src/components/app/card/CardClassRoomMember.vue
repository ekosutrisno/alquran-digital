        ...
        <div class="inline-flex space-x-3 items-start w-full">
            ...
            <div class="flex w-full items-start justify-between">
                ...
                <div v-if="member.user_id !== me" class="dark:text-slate-400 text-slate-400 mt-2 inline-flex space-x-2">
                    <svg @click="$router.push({name: 'ClassRoomChatPage',params:{ roomId: roomId }})" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover:text-sky-500 cursor-pointer transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.25">
