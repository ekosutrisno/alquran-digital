<template>
   <div class="mx-auto with-transition card-shadow-sm mb-4 w-full max-w-sm text-sm text-center relative group nv-transition text-slate-800 dark:text-slate-300 bg-white dark:bg-dark-blue ring-1 ring-slate-700/10 dark:ring-slate-700 p-2 font-semibold rounded-full select-none">
