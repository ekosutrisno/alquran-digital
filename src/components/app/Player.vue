<template>
    <div class="fixed inset-x-0 bottom-0 z-10 lg:left-112 xl:left-120">
        <div class="flex items-center gap-6 bg-white/90 dark:bg-slate-900/90 py-4 px-4 shadow-sm shadow-slate-200/80 ring-1 ring-slate-900/5 backdrop-blur-xs md:px-6">
            <div class="hidden md:block">
                <button type="button" class="amplitude-play group relative flex shrink-0 items-center justify-center rounded-full bg-slate-700 hover:bg-slate-900 focus:outline-hidden focus:ring-slate-700 h-14 w-14 focus:ring-2 focus:ring-offset-2" aria-label="Play">
            ...
            <div class="mb-[env(safe-area-inset-bottom)] flex flex-1 flex-col gap-3 overflow-hidden p-1">
                ...
                <div class="flex justify-between gap-6">
                    <div class="flex items-center md:hidden">
                        <button type="button" class="group relative rounded-md hover:bg-slate-100 focus:outline-hidden focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 md:order-0" aria-label="Mute">
                    ...
                    <div class="flex flex-none items-center gap-4">
                        <button type="button" @click="fastForward(-forwardBackward)" class="group relative rounded-full focus:outline-hidden" aria-label="Rewind 10 seconds">
                        ...
                        <div class="md:hidden">
                            <button type="button" class="group relative flex shrink-0 items-center justify-center rounded-full bg-slate-700 hover:bg-slate-900 focus:outline-hidden focus:ring-slate-700 h-10 w-10 focus:ring-2 focus:ring-offset-2" aria-label="Play">
                                <div class="absolute -inset-3 md:hidden"></div>
                        ...
                        <button type="button" @click="fastForward(forwardBackward)" class="group relative rounded-full focus:outline-hidden" aria-label="Fast-forward 10 seconds">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span class="amplitude-playback-speed"></span>
                            <button type="button" @click="playbackSpeedUpdate" class="relative flex h-6 w-6 items-center justify-center rounded-md text-slate-500 hover:bg-slate-100 hover:text-slate-700 focus:outline-hidden focus:ring-2 focus:ring-slate-400 focus:ring-offset-2" aria-label="Playback rate">
                                <div class="absolute -inset-4 md:hidden"></div>
                                <div class="bg-slate-500 text-white font-semibold rounded-sm h-5 w-5 flex items-center justify-center">
                        ...
                        <div class="hidden items-center md:flex">
                            <button type="button" class="amplitude-mute group relative rounded-md hover:bg-slate-100 focus:outline-hidden focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 md:order-0" aria-label="Mute">
        ...
        <!-- Audio Tags -->
        <!-- <audio class="focus:outline-hidden mb-4 sm:mr-4 sm:mb-0 float-right nv-transition mt-2 h-8 w-full max-w-md bg-transparent" preload="auto" :src="currentPlay?.audio">
