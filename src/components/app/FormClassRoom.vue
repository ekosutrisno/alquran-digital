<template>
    <form @submit.prevent="send" class="md:col-span-4 mt-4 md:mt-0 w-full max-w-lg space-y-5">
        ...
        <button type="submit"
            class="mt-6 float-right inline-flex justify-center py-2 px-3 border border-transparent shadow-xs text-sm font-medium rounded-md text-white bg-sky-500 hover:bg-sky-400 transition focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">
            <span>Simpan</span>
        </button>
    </form>
</template>
