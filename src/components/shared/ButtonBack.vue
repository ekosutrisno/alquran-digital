<template>
    <button type="button" @click="$router.back()" class="mt-8 inline-flex justify-center py-2 px-4 text-sm font-medium rounded-md text-slate-700 hover:text-sky-500 md:hover:ring-1 transition dark:text-white dark:hover:text-sky-500 hover:border-slate-800/25 absolute left-1.5 md:left-14 top-5 z-10">
