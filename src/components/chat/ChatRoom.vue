...
<div class="flex-1 sm:py-4 justify-between flex flex-col h-full">
   ...
   <div class="border-t-2 border-gray-200 mb-2 sm:mb-0">
      <ChatInput v-model:content="state.chatMessage" @send="sendMessage"/>
   </div>
</div>
</template>
