...
<form @submit.prevent="send()" class="relative flex p-4">
    ...
    <button type="button" class="hidden lg:inline-flex items-center justify-center rounded-full h-12 w-12 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none">
    ...
    <div class="absolute right-3.5 items-center inset-y-0 flex">
        ...
        <button type="submit" class="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-sky-500 hover:bg-sky-400 focus:outline-none">
