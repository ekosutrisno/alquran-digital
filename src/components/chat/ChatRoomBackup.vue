...
<div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-full">
   ...
   <div ref="messages" class="flex flex-col space-y-4 p-3 overflow-y-auto light-scroll">
   ...
   <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
      <div class="relative flex">
         ...
         <input type="text" placeholder="Write your message!" class="w-full border-none focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3">
